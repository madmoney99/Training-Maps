...
function addCarrierStaticMenu()
 ...
 staticSpawns = MENU_MISSION:New( "Carrier Deck Layout", mainmenu) 
  ...
  MENU_MISSION_COMMAND:New ("Launch Layout On", staticSpawns, spawnLaunch)
  MENU_MISSION_COMMAND:New ("Launch Layout Off", staticSpawns, spawnOffLL)
  MENU_MISSION_COMMAND:New ("Recovery Layout On", staticSpawns, spawnRecovery)
  MENU_MISSION_COMMAND:New ("Recovery Layout Off", staticSpawns, spawnOffRecovery)
  MENU_MISSION_COMMAND:New ("Clear Deck", staticSpawns, spawnsAllOff)
  MENU_MISSION_COMMAND:New ("Full Deck", staticSpawns, spawnsAllOn)
end
