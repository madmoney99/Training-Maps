...
RangeNabatieh=RANGE:New("Nabatieh Range")
RangeNabatieh:SetFunkManOn()
RangeNabatieh:SetRangeRadius(15)
RangeNabatieh:AddBombingTargetGroup(GROUP:FindByName("Plinking TGTS"), 50, false)
RangeNabatieh:Start()
