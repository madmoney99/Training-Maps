	...
	local function initDBs() -- mist.DBs scope
		...
		do -- mist unitID funcs
			for id, idData in pairs(mist.DBs.unitsById) do
				...
				if type(idData.unitId) == "number" and mist.nextUnitId == "number" 
				or type(idData.unitId) == "string" and mist.nextUnitId == "string" then
                ...
                if type(idData.groupId) == "number" and mist.nextGroupId == "number" 
				or type(idData.groupId) == "string" and mist.nextGroupId == "string"then
